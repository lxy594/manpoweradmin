<template>
  <div v-loading="loading" class="myInfo">
    ...
    <div class="myInfoCont">
      <div class="myInfoPic">
        <img src="@/assets/common/xx.jpg" width="100" alt>
      </div>
      <div>
...
import { UpdaPersoin, getPersonMess } from '@/api/employees'
...
export default {
  ...
  methods: {
    ...
    async getUserInfo() {
      this.loading = true
      const detailData = await getUserheadByid(this.userId)
      const personData = await getPersonMess(this.userId)
